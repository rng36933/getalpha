...
export default async function MacroDeskPage() {
  ...
  return (
    <>
      ...
      <div className="surface-static grid grid-cols-1 divide-y divide-line overflow-hidden rounded-lg border border-line bg-surface sm:grid-cols-2 sm:divide-x sm:divide-y-0 xl:grid-cols-4">
