  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <header className="sticky top-0 z-40 border-b border-white/[0.05] bg-background/80 backdrop-blur-md">
        <div className="mx-auto flex max-w-6xl items-center justify-between gap-4 px-5 py-3.5 sm:px-8">
          ...
          <div className="flex items-center gap-4 text-sm sm:gap-5">
            ...
            <Link href="/status" className="hidden text-zinc-400 transition-all duration-300 ease-in-out hover:text-white sm:inline">
              Status
            </Link>
      ...
      {/* Grain overlay now lives once in the root layout (GrainOverlay),
          covering every page instead of being duplicated per-layout. */}
    </div>
  );
}
