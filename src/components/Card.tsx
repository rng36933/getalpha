...
export default function Card({
  ...
  return (
    ...
    <section
      ...
      className={`surface-lit card-enter relative isolate flex h-full flex-col rounded-lg border border-line bg-surface p-4 sm:p-5 ${className}`}
    >
      <header className="flex items-center justify-between gap-3">
        ...
        {children ? null : (
          <span className="rounded-md bg-surface-raised px-2 py-0.5 font-mono text-[10px] font-medium uppercase tracking-wider text-muted">
            Soon
          </span>
        )}
      </header>
