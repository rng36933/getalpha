  ...
  return (
    <aside className="sticky top-0 z-10 hidden h-screen w-60 shrink-0 flex-col border-r border-line bg-surface backdrop-blur-md sm:flex">
      <div className="flex h-16 items-center gap-2.5 border-b border-line px-5">
        <span className="grid size-8 shrink-0 place-items-center rounded-md bg-accent text-base font-bold text-background">
          α
        </span>
        ...
        {NAV_ITEMS.map((item) => {
          ...
          return (
            <Link
              ...
              className={`flex items-center gap-3 rounded-r-md border-l-2 px-3 py-2.5 text-sm transition-colors ${
                active
